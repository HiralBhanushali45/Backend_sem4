...
console.log(path.extname('Lab 4\P1.js'))
console.log(path.basename('Lab 4\P1.js'))
console.log(path.join('users', 'arjun', 'documents', 'project'))
console.log(path.normalize("//folder//subfolder////file.txt"))
console.log(path.isAbsolute('Lab 4\P1.js'))
console.log(path.isAbsolute("Lab 4P1.js"))
